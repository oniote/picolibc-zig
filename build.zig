...
const module_name = "picolibc";

const c_headers = .{
    "newlib/libc/include",
    "newlib/libm/common",
    "newlib/libc/stdio",
    "newlib/libc/stdio/sys",
};
...
fn pico_path(b: *std.Build, comptime sub_path: []const u8) std.Build.LazyPath {
    return b.path(module_name ++ "/" ++ sub_path);
}
...
pub fn build(b: *std.Build) !void {
    ...
    if (target.query.os_tag != .freestanding) {
        std.debug.print("only supports freestanding\n", .{});
        return;
    }
    ...
    const picolibc_h = b.addConfigHeader(.{
        ...
        .style = .{
            .cmake = pico_path(b, "picolibc.h.in"),
        },
    }, picolibc_h_val);
    ...
    //     .use_lld = false,
    // });
    const newlib = b.addModule(module_name, .{ .target = target, .optimize = optimize });

    newlib.addConfigHeader(picolibc_h);
    newlib.addConfigHeader(reent_h);

    inline for (c_headers) |header| {
        newlib.addSystemIncludePath(pico_path(b, header));
    }
    newlib.addCMacro("_LIBC", null orelse "1");
    newlib.addCMacro("TZNAME_MAX", "10");
    switch (target.query.cpu_arch.?) {
        .avr => {
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/avr/setjmp.S"));
        },
        .arc => {
            newlib.addSystemIncludePath(pico_path(b, "newlib/libc/machine/arc"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/memcmp-bs-norm.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/memcmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/memcpy-archs.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/memcpy-bs.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/memcpy.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/memset-archs.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/memset-bs.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/memset.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/setjmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/strchr-bs-norm.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/strchr-bs.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/strchr.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/strcmp-archs.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/strcmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/strcpy-bs-arc600.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/strcpy-bs.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/strcpy.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/strlen-bs-norm.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/strlen-bs.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/strlen.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/strncpy-bs.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arc/strncpy.S"));
        },
        .arm, .armeb => {
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arm/aeabi_memcpy-armv7a.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arm/memchr.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arm/memcpy.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arm/memset-arm.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arm/memset.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arm/setjmp.S"));
            // TODO
            // switch (newlib.rootModuleTarget().cpu.model.toCpu(.arm)) {
            //     else => {},
            // }
            // newlib.addAssemblyFile(pico_path(b,"newlib/libc/machine/arm/memcpy-armv7a.S"));
            // newlib.addAssemblyFile(pico_path(b,"newlib/libc/machine/arm/memcpy-armv7m.S"));
            // newlib.addAssemblyFile(pico_path(b,"newlib/libc/machine/arm/strcmp-arm-tiny.S"));
            // newlib.addAssemblyFile(pico_path(b,"newlib/libc/machine/arm/strcmp-armv4.S"));
            // newlib.addAssemblyFile(pico_path(b,"newlib/libc/machine/arm/strcmp-armv4t.S"));
            // newlib.addAssemblyFile(pico_path(b,"newlib/libc/machine/arm/strcmp-armv6.S"));
            // newlib.addAssemblyFile(pico_path(b,"newlib/libc/machine/arm/strcmp-armv6m.S"));
            // newlib.addAssemblyFile(pico_path(b,"newlib/libc/machine/arm/strcmp-armv7.S"));
            // newlib.addAssemblyFile(pico_path(b,"newlib/libc/machine/arm/strcmp-armv7m.S"));
            // newlib.addAssemblyFile(pico_path(b,"newlib/libc/machine/arm/strlen-armv7.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arm/strcmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arm/strcpy.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arm/strlen.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/picolib/machine/arm/read_tp.S"));
        },
        .thumb, .thumbeb => {
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arm/memchr.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arm/memcpy.S"));
            ...
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arm/strlen.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/picolib/machine/arm/read_tp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arm/memset-thumb.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/arm/strlen-thumb1-Os.S"));
            // newlib.addAssemblyFile(pico_path(b,"newlib/libc/machine/arm/memset-thumb2.S"));
            // newlib.addAssemblyFile(pico_path(b,"newlib/libc/machine/arm/strlen-thumb2-Os.S"));
        },
        .aarch64, .aarch64_be => {
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/memchr.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/memcmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/memcpy.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/memmove.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/memrchr.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/memset.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/rawmemchr.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/setjmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/stpcpy.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/strchr.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/strchrnul.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/strcmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/strcpy.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/strlen.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/strncmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/strnlen.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/aarch64/strrchr.S"));
        },
        .m68k => {
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/m68k/memcpy.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/m68k/memset.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/m68k/setjmp.S"));
        },
        .mips, .mipsel => {
            newlib.addSystemIncludePath(pico_path(b, "newlib/libc/machine/mips"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/mips/memcpy.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/mips/memset.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/mips/setjmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/mips/strcmp.S"));
        },
        .riscv32, .riscv64 => {
            newlib.addSystemIncludePath(pico_path(b, "newlib/libc/machine/riscv"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/riscv/memcpy-asm.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/riscv/memmove.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/riscv/memset.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/riscv/setjmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/riscv/strcmp.S"));
        },
        .sparc => {
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/sparc/setjmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/picolib/machine/sparc/interrupt.S"));
        },
        .spu_2 => {
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/fiprintf.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/fiscanf.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/fprintf.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/fscanf.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/iprintf.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/iscanf.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/printf.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/scanf.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/setjmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/siprintf.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/siscanf.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/sniprintf.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/snprintf.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/sprintf.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/spu-mcount.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/spu_timer_flih.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/sscanf.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/spu/stack_reg_va.S"));
        },
        .x86, .x86_64 => {
            if (target.query.cpu_arch.? == .x86_64) {
                newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/memcpy-64.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/memset-64.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/setjmp-64.S"));
                newlib.addAssemblyFile(pico_path(b, "picocrt/machine/x86/crt0-64.S"));
            } else {
                newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/memchr-32.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/memcmp-32.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/memcpy-32.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/memmove-32.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/memset-32.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/setjmp-32.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/strlen-32.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/strchr-32.S"));
                newlib.addAssemblyFile(pico_path(b, "picocrt/machine/x86/crt0-32.S"));

                // libm
                newlib.addAssemblyFile(pico_path(b, "newlib/libm/machine/x86/f_atan2.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libm/machine/x86/f_atan2f.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libm/machine/x86/f_frexp.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libm/machine/x86/f_frexpf.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libm/machine/x86/f_ldexp.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libm/machine/x86/f_ldexpf.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libm/machine/x86/f_log.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libm/machine/x86/f_log10.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libm/machine/x86/f_log10f.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libm/machine/x86/f_logf.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libm/machine/x86/f_tan.S"));
                newlib.addAssemblyFile(pico_path(b, "newlib/libm/machine/x86/f_tanf.S"));
            }
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/memchr.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/memcmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/memcpy.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/memmove.S"));

            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/memset.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/setjmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/strchr.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/x86/strlen.S"));
        },
        .xtensa => {
            newlib.addSystemIncludePath(pico_path(b, "newlib/libc/machine/xtensa"));
            newlib.addSystemIncludePath(pico_path(b, "newlib/libc/sys/xtensa/include/xtensa/config"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/xtensa/memcpy.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/xtensa/memset.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/xtensa/setjmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/xtensa/strcmp.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/xtensa/strcpy.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/xtensa/strlen.S"));
            newlib.addAssemblyFile(pico_path(b, "newlib/libc/machine/xtensa/strncpy.S"));
        },
        else => {},
    }

    // inline for (libc_lists) |node| {
    //     newlib.addCSourceFiles(.{
    //         .root = pico_path(b, node.root),
    //         .files = node.files,
    //         .flags = cflags,
    //     });
    // }

    // inline for (libm_lists) |node| {
    //     newlib.addCSourceFiles(.{
    //         .root = pico_path(b, node.root),
    //         .files = node.files,
    //         .flags = cflags,
    ...
    newlib.addCSourceFiles(.{
        .root = pico_path(b, ""),
        .files = switch (target.query.cpu_arch.?) {
    ...
    // const newlib_lib = b.addStaticLibrary(.{
    //     .name = "c",
    //     .target = target,
    //     .optimize = optimize,
    //     .link_libc = false,
    ...
    // newlib_lib.root_module.addImport(module_name, newlib);

    // newlib_lib.installHeadersDirectory(
    //     pico_path(b, "newlib/libc/include"),
    //     "",
    //     .{
    //         .exclude_extensions = &.{
    //             "c",
    ...
    // newlib_lib.addConfigHeader(picolibc_h);
    // newlib_lib.addConfigHeader(reent_h);

    // newlib_lib.installHeadersDirectory(
    //     pico_path(b, "newlib/libc/stdio"),
    //     "",
    //     .{
    //         .exclude_extensions = &.{
    //             "c",
    ...
    // newlib_lib.installHeader(picolibc_h.getOutput(), "picolibc.h");
    // b.installArtifact(newlib_lib);
    ...
    //     .file = pico_path(b,"hello-world/hello-world.c" },
    //     .flags = cflags,
    // });
    // const link_libcxx = hello.root_module.link_libcpp orelse false;
    // hello.setLinkerScript(pico_path(b,switch (hello.rootModuleTarget().cpu.arch) {
    ...
    // hello.setLinkerScript(pico_path(b,"hello-world/picolibc.ld" });
    // hello.linkLibrary(newlib);
    // b.installArtifact(hello);
}

pub fn add_module(b: *std.Build, exe: *std.Build.Step.Compile) void {
    ...
    const dependency = b.dependency(module_name, .{
        .target = target,
        .optimize = optimize,
    });
    ...
    for (module.include_dirs.items) |dir| switch (dir) {
        ...
        => {},
        .config_header_step => |c| {
            lib.installHeader(c.getOutput(), c.include_path);
        },
        .other_step => {}, // Assumed to be done through link_objects
    };

    lib.installHeadersDirectory(
        dependency.path(module_name ++ "/" ++ "newlib/libc/include"),
        "",
        .{
            .exclude_extensions = &.{
                "c",
    ...
    lib.installHeadersDirectory(
        dependency.path(module_name ++ "/" ++ "newlib/libc/stdio"),
        "",
        .{
            .exclude_extensions = &.{
                "c",
    ...
    //std.debug.print("{s}", .{b.getInstallPath(.header, "")});
    //exe.addSystemIncludePath(.{ .cwd_relative = b.getInstallPath(.header, "") });
    exe.linkLibrary(lib);
...
const libc_lists = &[_]file_path{
    .{
        .root = "newlib/libc/argz",
        .files = &.{
            "argz_add.c",
            "argz_add_sep.c",
            "argz_append.c",
    ...
    // },
    // .{
    //     .root = "newlib/libc/errno",
    //     .files = &.{"errno.c"},
    // },
    // .{
    //     .root = "newlib/libc/iconv",
    //     .files = &.{
    //         "iconv.c",
    //         "iconv_close.c",
    //         "iconv_open.c",
...
const libm_lists = &[_]file_path{
    .{
        .root = "newlib/libm/complex",
        .files = &.{
            "cabs.c", //double
            "cacos.c",
            "cacosh.c",
